...
export function inferCredibilityTier(text, source, rating) {
...
export function scoreSignal(text, source, rating) {
...
export function aggregatePlatformScores(entries) {
  if (!entries.length) {
    return {
      supportScore: 50,
